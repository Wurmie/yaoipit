...
<body>
	<div class="box">
		...
		<a href="Yaoi.php"><h3 class="goBack">Back</h3></a>
			<div class="profile">
				<img src="Images/icons/nonBL/<?php echo $_GET['chapterName']; ?>.png">
			</div>
			<div class="profileText">
				<p><h1><?php echo $_GET['chapterName']; ?></h1></p>
				<p><?php
					$sql = "SELECT Description FROM nonYaoiManga WHERE Name='$chapterName'";
	...
	<script>
		...
		function getChapter(chapter) {
			...
			window.location.href=("nonYaoiChapter.php?thisChapter=" + thisChapter + "&numbChapters=" + numbChapters + "&chapterName=" + chapterName);
		}
	</script>
</body>
</html>
